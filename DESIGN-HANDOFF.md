# Junry Virtucio Portfolio implementation handoff

This archive is the source of truth for the production portfolio. Start from `index.html`, with visual styles in `styles.css` and interactions in `script.js`.
...
- Keep `index.html`, `styles.css`, and `script.js` as separate production files so structure, styling, and behavior remain maintainable.
...
- The production design tokens live in the `:root` block at the top of `styles.css`.

## Implementation sequence for AI coding tools
1. Open `index.html`, `styles.css`, `script.js`, and `DESIGN-MANIFEST.json`; identify every screen region and interaction before coding.
...
1. Inspect `index.html`, `styles.css`, `script.js`, and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
